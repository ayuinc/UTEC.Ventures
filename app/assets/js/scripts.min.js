...
function enableordisable() {
    "" !== $("#search_bar").val() ? $("#search_button").removeAttr("disabled") : $("#search_button").attr("disabled", "disabled");
}
...
!function(a, b) {
    ...
    a >= 658 ? $(".header-scroll").addClass("active") : $(".header-scroll").removeClass("active");
}), $("#search_bar").keypress(enableordisable), $(".menu-toggle").on("click", function() {
    $(this).toggleClass("on"), $(".menu-section").toggleClass("on"), $("nav ul").toggleClass("hidden");
}), function() {
    "use-strict";
